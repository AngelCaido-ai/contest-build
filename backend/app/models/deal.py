...
class Deal(Base):
    ...
    publish_at: Mapped[datetime | None] = mapped_column(TZDateTime, nullable=True)
    ...
    verification_started_at: Mapped[datetime | None] = mapped_column(TZDateTime, nullable=True)
